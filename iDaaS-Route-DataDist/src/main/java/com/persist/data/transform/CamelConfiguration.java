...
public class CamelConfiguration extends RouteBuilder {
    ...
    @Bean
    public BuildDBEvent buildDBEvent(){return new BuildDBEvent();}
    ...
    private String getCouchDBUri(String dbname){

        return "couchdb:http://169.47.93.106:5984/"+dbname+"?username=admin&password=pass";
    }
    /*
    ...
    public void configure() throws Exception {
        ...
        from(getKafkaTopicUri("ent_fhirsvr_allergyintollerance"))
                ...
                .convertBodyTo(String.class)
                .bean(BuildDBEvent.class,"returncouchDBJSon(${body})")
                .to(getCouchDBUri("cdp"))
